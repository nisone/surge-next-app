export default function Contact() {
    return (
        <div class="container my-24 px-6 mx-auto">
            <section class="mb-32 text-gray-800" id="contact">
                            ...
                            <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="grow ml-6">
                                        ...
                                        <p class="text-gray-500">support@surgeryders.com</p>
                                        <p class="text-gray-500">+234 904-7327-525</p>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="grow ml-6">
                                        ...
                                        <p class="text-gray-500">sales@surgeryders.com</p>
                                        <p class="text-gray-500">+234 904-7327-525</p>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                <div class="flex align-start">
                                    ...
                                    <div class="grow ml-6">
                                        ...
                                        <p class="text-gray-500">press@surgeryders.com</p>
                                        <p class="text-gray-500">+234 904-7327-525</p>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                <div class="flex align-start">
                                    ...
                                    <div class="grow ml-6">
                                        ...
                                        <p class="text-gray-500">bugs@surgeryders.com</p>
                                        <p class="text-gray-500">+234 904-7327-525</p>
                                    </div>
                                </div>
                            </div>
