...
export default function TopFixedNavbar() {
  ...
  <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
    <li class="nav-item p-2">
      <Link class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" href="/">Home</Link>
    </li>
    <li class="nav-item p-2">
      <Link class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" href="/about" scroll={false}>About</Link>
    </li>
    {/* <li class="nav-item p-2">
      <Link class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" href="/contact" scroll={true}>Contact us</Link>
    </li> */}
  </ul>
  </div>
  ...
  {/* <div class="dropdown relative">
    <a class="dropdown-toggle flex items-center hidden-arrow" href="#" id="dropdownMenuButton2" role="button"
      ...
      <Image src="/image/step1.jpg" class="rounded-full" height={25} width={25}
